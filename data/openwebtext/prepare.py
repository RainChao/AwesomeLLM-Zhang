...
if __name__ == '__main__':
    ...
    dataset = load_dataset(
        "openwebtext", num_proc=num_proc_load_dataset, cache_dir=os.path.dirname(__file__))
    ...
    for split, dset in tokenized.items():
        ...
        for batch_idx in tqdm(range(total_batches), desc=f'writing {filename}'):
            ...
            batch = dset.shard(
                num_shards=total_batches, index=batch_idx, contiguous=True).with_format('numpy')
